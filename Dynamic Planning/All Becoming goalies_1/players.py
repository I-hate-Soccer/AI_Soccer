...
try:
    ...
    print('player_rulebasedE: \'participant\' module cannot be imported:', err)
    raise
                ...
                if gk_control == None:
                    if (cur_posture[self.gk_index][BALL_POSSESSION]):
                        ...
                        if -self.field[X]/2 - 0.05 < cur_posture[self.gk_index][X] < -self.field[X]/2 + 0.15 and -0.02 < cur_posture[self.gk_index][Y] < 0.02:
                            ...
                            gk_control = self.action.go_to(self.gk_index, self.field[X]/2, 0)
                # D1
                d1_control = self.action.go_to(self.d1_index, self.field[X]/2, 0)
                # D2
                d2_control = self.action.go_to(self.d2_index, self.field[X]/2, 0)
                # F1
                f1_control = self.action.go_to(self.f1_index, self.field[X]/2, 0)
                # F2
                f2_control = self.action.go_to(self.f2_index, self.field[X]/2, 0)
                self.flag = 1
            # D1 ZONE
            ...
            # D2 ZONE
                ...
                if (cur_posture[self.d2_index][BALL_POSSESSION]):
                    ...
                    if (cur_posture[self.d2_index][X] > predicted_ball[X]):
                        ...
                        d2_control = self.action.go_to(self.d2_index, self.field[X]/2, 0)                      
                # F1
                f1_control = self.action.go_to(self.f1_index, self.field[X]/2 - 0.01, 0)
                # F2
                if cur_ball[X] < 0:
                    f2_control = self.action.go_to(self.f2_index, self.field[X]/2, 0)
                else:
            ...
            # F1 ZONE
                ...
                if gk_control == None:
                    if -self.field[X]/2 - 0.05 < cur_posture[self.gk_index][X] < -self.field[X]/2 + 0.15 and -0.02 < cur_posture[self.gk_index][Y] < 0.02:
                        ...
                        gk_control = self.action.go_to(self.gk_index, self.field[X]/2, 0)
                # D1
                d1_control = self.action.go_to(self.d1_index, self.field[X]/2 - 0.01, 0)
                # D2
                d2_control =  self.action.go_to(self.d2_index, self.field[X]/2, 0)
                # F1
